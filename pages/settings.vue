          ...
          <ul class="space-y-2">
            <li>
              <button 
                ...
                :class="activeTab === 'profile' ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-100'"
              >
            ...
            <li>
              <button 
                ...
                class="w-full text-left px-4 py-2 rounded-md transition-colors"
                :class="activeTab === 'security' ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-100'"
              >
                <span class="flex items-center">
            ...
            <li>
              <button 
                ...
                class="w-full text-left px-4 py-2 rounded-md transition-colors"
                :class="activeTab === 'notifications' ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-100'"
              >
                <span class="flex items-center">
            ...
            <li>
              <button 
                ...
                class="w-full text-left px-4 py-2 rounded-md transition-colors"
                :class="activeTab === 'appearance' ? 'bg-blue-50 text-blue-600' : 'hover:bg-gray-100'"
              >
                <span class="flex items-center">
            ...
            <form @submit.prevent="saveProfile">
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <div class="text-gray-700 py-2">{{ getRoleName(profile.role) }}</div>
                </div>
              ...
              <div class="border rounded-md divide-y">
                <div class="p-4">
                  <div class="flex justify-between items-center">
                    <div>
                      <div class="font-medium">Este dispositivo</div>
                      <div class="text-sm text-gray-500">Windows · Chrome · Santiago, Chile</div>
                    </div>
                    <div>
            ...
            <div class="space-y-4">
              <div class="flex items-center justify-between py-2 border-b">
                <div>
                  ...
                  <div class="text-sm text-gray-500">Recibir notificaciones por correo electrónico</div>
                </div>
                <div>
              ...
              <div class="flex items-center justify-between py-2 border-b">
                <div>
                  <div class="font-medium">Notificaciones de documentos</div>
                  <div class="text-sm text-gray-500">Cuando un documento es validado o rechazado</div>
                </div>
                <div>
                  <label class="relative inline-flex items-center cursor-pointer">
              ...
              <div class="flex items-center justify-between py-2 border-b">
                <div>
                  <div class="font-medium">Notificaciones de proyectos</div>
                  <div class="text-sm text-gray-500">Cuando es asignado a un nuevo proyecto</div>
                </div>
                <div>
                  <label class="relative inline-flex items-center cursor-pointer">
