        ...
        <div class="px-4 py-6 sm:px-0">
          ...
          <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-4 sm:space-y-0 mb-6">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <select class="input py-2" v-model="filterProject">
            ...
            <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
              ...
              <div>
                <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                  ...
                  <a href="#" class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-primary-600 ring-1 ring-inset ring-gray-300 hover:bg-gray-50">1</a>
